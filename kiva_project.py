...
get_ipython().set_next_input("print('I have no recomendations but questions: Why there is less gender disparity in Philippines and El Salvador");get_ipython().run_line_magic('pinfo', 'Salvador')


# In[ ]:


print('I have no recomendations but questions: Why there is less gender disparity in Philippines and El Salvador
...
print('Maybe they could diagnose the reasons why there is so much gender disparity.')
...
print('The farm activity gets more loans than the others.')
...
plt.figure(figsize=(16, 10))
sns.violinplot(data = df, y='loan_amount', x='country')
...
print('Well, in Philipines women gets lower loans but in more proportion than the men.')
